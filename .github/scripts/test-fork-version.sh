...
[[ "$(tr -d '[:space:]' <"${version_file}")" == "0.144.6" ]] ||
  fail "update did not write 0.144.6"
...
create_upstream "${prerelease_only}" rust-v0.145.0-alpha.24
no_stable_output=""
