...
impl Session {
    ...
    pub(crate) async fn capture_step_context(
        ...
        let environment_selections_changed = self
            ...
            .await;
        // Keep selections fixed for the turn while allowing startup work to finish, unless a
        // settings tool changed the live selections during this turn.
        let environments = if environment_selections_changed {
