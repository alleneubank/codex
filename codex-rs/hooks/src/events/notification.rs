...
impl NotificationType {
    ...
    fn message(self) -> &'static str {
        match self {
            Self::UserInputRequest | Self::ElicitationDialog | Self::ElicitationUrlDialog => {
                INPUT_NEEDED_MESSAGE
            }
            Self::UserInputComplete | Self::ElicitationComplete => INPUT_COMPLETE_MESSAGE,
        }
    }
}
