...
use crate::app_event::PendingSteerWithdrawalRequestResult;
...
use crate::chatwidget::SessionReasoningEffortState;
...
pub(crate) struct App {
    ...
    session_reasoning_effort_states: HashMap<ThreadId, SessionReasoningEffortState>,
