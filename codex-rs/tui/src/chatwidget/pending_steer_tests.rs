...
struct Queues {
    ...
    rejected_sources: VecDeque<UserMessageSource>,
...
fn queues_with_target(lifecycle: PendingSteerLifecycle) -> Queues {
    Queues {
        ...
        rejected_sources: VecDeque::from([UserMessageSource::Prompt]),
...
fn queues_after_target_rejection() -> Queues {
    Queues {
        ...
        rejected_sources: VecDeque::from([UserMessageSource::Prompt, UserMessageSource::Prompt]),
