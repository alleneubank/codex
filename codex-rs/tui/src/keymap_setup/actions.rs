...
pub(super) const KEYMAP_ACTIONS: &[KeymapActionDescriptor] = &[
    ...
    action("global", "Global", "cycle_permission_mode", "Cycle through permission modes."),
    ...
    action("chat", "Chat", "stash_prompt", "Temporarily stash or restore the current draft."),
...
pub(super) fn binding_slot<'a>(
    ...
    match (context, action) {
        ...
        ("global", "cycle_permission_mode") => Some(&mut keymap.global.cycle_permission_mode),
        ...
        ("chat", "stash_prompt") => Some(&mut keymap.chat.stash_prompt),
...
pub(super) fn bindings_for_action<'a>(
    ...
    match (context, action) {
        ...
        ("global", "cycle_permission_mode") => Some(runtime_keymap.app.cycle_permission_mode.as_slice()),
        ...
        ("chat", "stash_prompt") => Some(runtime_keymap.chat.stash_prompt.as_slice()),
